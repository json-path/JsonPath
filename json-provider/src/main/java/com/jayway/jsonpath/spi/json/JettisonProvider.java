...
public class JettisonProvider extends AbstractJsonProvider
{
	...
	private Object parse(JettisonTokener JsonTokener, boolean strict){
		try
		{
			Object o = null;
			...
			switch(nextChar) {
				case '{':
					o = new JettisonObject(JsonTokener);
					break;
				case '[':
					o = new JettisonArray(JsonTokener);
				default:
					if(strict)
					{
						throw new InvalidJsonException("Invalid JSON");						
					}
					o =  JsonTokener.nextValue();
					break;
			}
			return o;
		}
	...
	public Object parse(String json, boolean strict) throws InvalidJsonException{
		return parse(new JettisonTokener(json), strict);
	}
	...
	public Object parse(InputStream jsonStream, String charset, boolean strict) throws InvalidJsonException{
		try
		{
			...
			return parse(new JettisonTokener(new String(stream.toByteArray(), charset)),strict);
		}
