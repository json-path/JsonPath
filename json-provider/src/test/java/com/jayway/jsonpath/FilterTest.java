...
public class FilterTest extends BaseTestConfiguration {
    ...
    public void json_evals() {
        ...
        Object tree = Configuration.defaultConfiguration().jsonProvider().parse(json, false);
    ...
    public void testFilterWithOrShortCircuit1() throws Exception {
        Object json = Configuration.defaultConfiguration().jsonProvider().parse( "{\"firstname\":\"Bob\",\"surname\":\"Smith\",\"age\":30}", false);
