...
public class ProviderInTest {
    ...
    public void testJsonPathQuotesJackson() throws Exception {
        ...
        final DocumentContext ctx = JsonPath.using(jackson).parse(JSON, false);
    ...
    public void testJsonPathQuotesJacksonJsonNode() throws Exception {
        ...
        final DocumentContext ctx = JsonPath.using(jacksonJsonNode).parse(JSON, false);
    ...
    public void testJsonPathQuotesGson() throws Exception {
        ...
        final DocumentContext ctx = JsonPath.using(gson).parse(JSON, false);
    ...
    public void testJsonPathQuotesJsonSmart() throws Exception {
        ...
        final DocumentContext ctx = JsonPath.using(jsonSmart).parse(JSON, false);
