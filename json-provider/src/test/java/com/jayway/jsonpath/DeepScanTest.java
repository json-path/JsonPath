...
public class DeepScanTest {
    ...
    public void require_single_property_ok() {
        ...
        Configuration configuration = BaseTestConfiguration.JSON_SMART_CONFIGURATION.addOptions(Option.REQUIRE_PROPERTIES);
    ...
    public void scan_for_property_path_missing_required_property() {
        ...
        assertThat(using( BaseTestConfiguration.JSON_SMART_CONFIGURATION.addOptions(
