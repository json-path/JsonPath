...
public class JsonPathTest extends BaseTest {
    ...
    @Test
    public // see https://code.google.com/p/json-path/issues/detail?id=58
    void invalid_paths_throw_invalid_path_exception() throws Exception {
    ...
    public //see https://github.com/json-path/JsonPath/issues/428
    void prevent_stack_overflow_error_when_unclosed_property() {
