...
public class WriteTest extends BaseTest {
    ...
    public void multi_prop_delete() {
        ...
        assertThat(res).isEqualTo(new ArrayList() {{
        	this.add(EMPTY_MAP);
        	this.add(EMPTY_MAP);
        	this.add(EMPTY_MAP);
        	this.add(EMPTY_MAP);
    ...
    public void multi_prop_update() {
        ...
        List res = parse(JSON_DOCUMENT).set("$.store.book[*]['author', 'category']", "a").read("$.store.book[*]['author', 'category']");
    ...
    public void multi_prop_update_not_all_defined() {
        ...
        List res = parse(JSON_DOCUMENT).set("$.store.book[*]['author', 'isbn']", "a").read("$.store.book[*]['author', 'isbn']");
    ...
    public void object_can_be_mapped(){
        ...
        MapFunction mapFunction = new ToStringMapFunction();
        DocumentContext documentContext = JsonPath.using(CONFIGURATION).parse(JSON_DOCUMENT);
        Object list = documentContext.read("$..book");
        assertThat(list).isInstanceOf(List.class);
        Object result = documentContext.map("$..book", mapFunction).read("$..book", typeRef).get(0);
        assertThat(result).isInstanceOf(String.class);
        assertThat((String)result).endsWith("converted");
    }
